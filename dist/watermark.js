...
exports.filter = exports.rotate = exports.fullMarker = exports.QRcode = exports.blur = exports.mosaic = exports.imgWaterMarker = void 0;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.grayscale = exports.filter = void 0;
var baseInterface_1 = __webpack_require__(16);
var imgInstance_1 = __webpack_require__(6);
var canvasInstance_1 = __webpack_require__(4);
var error_1 = __webpack_require__(7);
function filter(_a) {
    var _this = this;
    var src = _a.src, type = _a.type, _b = _a.output, output = _b === void 0 ? 'jpeg' : _b;
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var _a, canvas, ctx, img, width, height, imgData;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = (0, canvasInstance_1.createCanvas)(), canvas = _a.canvas, ctx = _a.ctx;
                ...
                case 1:
                    ...
                    imgData = ctx.getImageData(0, 0, width, height);
                    switch (type) {
                        case baseInterface_1.TFilterType.黑白滤镜:
...
function grayscale(imageData, ctx) {
 ...
 */
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.TFilterType = void 0;
var TFilterType;
(function (TFilterType) {
    TFilterType[TFilterType["\u9ED1\u767D\u6EE4\u955C"] = 0] = "\u9ED1\u767D\u6EE4\u955C";
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.filter = exports.rotate = exports.fullMarker = exports.QRcode = exports.blur = exports.mosaic = exports.marker = void 0;
...
Object.defineProperty(exports, "filter", ({ enumerable: true, get: function () { return index_1.filter; } }));
exports["default"] = { marker: index_1.imgWaterMarker, mosaic: index_1.mosaic, blur: index_1.blur, QRcode: index_1.QRcode, fullMarker: index_1.fullMarker, rotate: index_1.rotate, filter: index_1.filter };
